...
class LaunchServiceProviderTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {"England","China","USA"})
...
//    @DisplayName("should throw exception when pass null to setYear function")
//    @Test
//    public void shouldThrowExceptionWhenSetYearToNull(){
//        NullPointerException exception = assertThrows(NullPointerException.class, () -> target.setYear(null));
//        assertEquals("year can not be null or empty",exception.getMessage());
//    }
